...
If you don't want to set up the ESP-IDF toolchain locally, you can use our WebSerial-based open-source flasher at [flasher.borneoiot.com](https://flasher.borneoiot.com). It runs in your browser and communicates with the XIAO-ESP32C3 over USB.
